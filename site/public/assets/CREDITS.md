...
| `hero-stair-{700,1000,1400}.{jpg,webp}` | sent into chat | the marbled stairwell, and the hero plate. Supplied at 3024x4032, so unlike the shot it replaces this one has resolution to spare. Three widths behind a `<picture>`; WebP is about a third smaller on a texture this busy (296KB against 441KB at 1400w). Same job as `stair-marbled.jpg` and `staircase.mp4`. |
